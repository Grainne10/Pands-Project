...
# Next the Iris data set is loaded into a data frame using df in pandas. 
...
# This dtypes will show you the type of data that you are analysing. It determines Sepal length, Sepal Width,  Petal Length and Petal Width as the numbers are fractitional it detects they are floating numbers.  
...
# Without this it was printing the first section to code rather than returning a value to the file.  
...
# We will look at how some of these individual variables look using different charts and plots.
...
# Plots.py I have set up some modules to run the graphs in the plots.py file and import them using import so that this python file will not show too much code.

# Scatter plots use dots to represent values for two different numeric variables.  
# Scatter plots are used to observe relationships between variables.  

# This is a scatterplot of the sepal length vs sepal width and I show the species in different shapes and colours to identify them clearly,  
...
# A pairplot combines both histogram and scatter plots, it provides an overview of each pair of variables and shows the dataset's distributions and correlations.
...
# I use it to show each of the species separately and clearly.  
...
# Histograms are visual representations of the distribution of quantitative data.It takes all the data and divides the entire range of values into a series of intervals.
...
# To show correlation coefficient for numeric values we can do a matrix. Select only numeric columns for correlation calculation:
